...
const exp = [
    ...
    },
    {
        ...
        desp: "<li>Het Vigenère-cijfer is een methode om alfabetische tekst te versleutelen met behulp van een reeks verweven Caesar-cijfers, gebaseerd op de letters van een trefwoord. Het maakt gebruik van een vorm van polyalfabetische substitutie.",
    },
    {
        title: "Leuk weetje",
        time: "",
        cardImage: "assets/images/projecten-page/Escaperoom3.jpg",
        desp: "<li>Escaperooms vinden hun oorsprong in computergames. Rond de laatste</br> millenniumwisseling verschenen er namelijk diverse computerspelletjes</br> waarin een ontsnappingskamer centraal stond. Spelers moesten hierbij uit kamers zien te ontsnappen door mysteries op te lossen, met behulp van de voorwerpen in de ruimte. Deze spellen kwamen als ‘Escape Games’ of ‘Escaperooms’ bekend te staan.",
    },
];
