...
const exp = [
  {
    ...
    time: " ",
        desp: "<li><b>Doel</b></br> Het idee was om een game te maken die de ouderen tijdens corona bezig zouden houden en zich niet eenzaam voelen.</li><li><b>Opdracht gever</b></br>Minister Mark Rutte heeft de volgende opdracht voor jullie: Bestrijd het eenzaamheid-virus met in het oog de huidige maatregelen. Maak met de kennis die je opdoet over het maken van een app, een spel/idee/bordspel/teamspel om het eenzaamheid-virus tegen te gaan. Bijvoorbeeld oude mensen. <br> ‘Let een beetje op elkaar, ik reken op u’ – Mark Rutte",
  },
  {
    title: "Leuk weetje",
